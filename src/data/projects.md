...
| 标题 | 方法 | 目标期刊 | 身份 | 公开 |
|------|------|---------|------|------|
| 小样本房屋市政工程安全事故预测 | 机器学习 | Reliability Engineering and System Safety | 通讯 | ❌ |
| 智慧城市试点政策如何影响工业企业数字创新 | 双重差分 | IEEE Transactions on Engineering Management | 通讯 | ❌ |
| 数字化转型的持续性创新效应研究 | 多元回归 | | 通讯 | ❌ |
| 数字化竞争优势非线性 | 多元回归 | Journal of Management in Engineering | 一作 | ❌ |
...
| 建筑工程企业碳减排竞合博弈 | 合作-非合作两型博弈 | | 一作 | ❌ |
| 双重知识驱动下的装配式供应链智能决策 | 大语言模型 | Automation in Construction | 一作 | ❌ |
